...
def game_loop():
    ...
    line_vehi =random.randrange(1,4)
    #vehi_pos_x = random.randrange(0,dw-120)
    vehi_pos=['vehi_pos_x1','vehi_pos_x2','vehi_pos_x1']
    vehi_pos_x1 = 0*140+10
    vehi_pos_x2 = 1*140+10
    vehi_pos_x3 = 2*140+10
...
'''
        ...
        if line_vehi==1:
            vehi_pos_x1 = 0*140+10
            vehi(vehi_pos_x1,vehi_pos_y,i)   
            vehi_pos_y += vehi_speed
        if line_vehi==2:
            vehi_pos_x2 = 1*140+10
            vehi(vehi_pos_x2,vehi_pos_y,i)   
            vehi_pos_y += vehi_speed
        if line_vehi==3:
            vehi_pos_x3 = 2*140+10
            vehi(vehi_pos_x3,vehi_pos_y,i)   
            vehi_pos_y += vehi_speed 
